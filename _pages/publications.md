...
.pub-card--llm .pub-card__link {
  background: #7b5ea7;
}

.pub-card--llm .pub-card__link:hover {
  background: #654a8c;
}
...
.pub-card--llm:hover {
  border-left-color: #654a8c;
}

.pub-card--llm .pub-card__badge--preprint {
  background: #7b5ea7;
}
...
Recently, Large Language Models have become extremely adept at solving problems in theoretical computer science and mathematics (see [here](https://openai.com/index/ten-advances-in-mathematics/) or [here](https://openai.com/index/navier-stokes-solution/) for example). My collaborators and I have used these models to find solutions to several interesting problems in social choice theory and fair division. This section is for papers where the main result is generated by a large language model, and the paper includes a detailed explanation of that result and some context around it.
</div>
